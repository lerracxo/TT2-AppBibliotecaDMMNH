...
CREATE TABLE IF NOT EXISTS `BibliotecaDigital`.`seg_registroVisitante` (
  ...
  CONSTRAINT `fk_seg_registroVisitante_cat_rango_edades1`
    FOREIGN KEY (`id_rango_edad`)
    REFERENCES `BibliotecaDigital`.`cat_rango_edades` (`id_rango_edades`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_seg_registroVisitante_cat_ocupaciones1`
    FOREIGN KEY (`id_ocupacion`)
    REFERENCES `BibliotecaDigital`.`cat_ocupaciones` (`id_ocupacion`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_seg_registroVisitante_cat_estado_civil1`
    FOREIGN KEY (`id_estado_civil`)
    REFERENCES `BibliotecaDigital`.`cat_estado_civil` (`id_estado_civil`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_seg_registroVisitante_cat_razonVisita1`
    FOREIGN KEY (`id_razonVisita`)
    REFERENCES `BibliotecaDigital`.`cat_razonVisita` (`id_razonVisita`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_seg_registroVisitante_cat_freciencia_asustencia1`
    FOREIGN KEY (`id_frecuencia_asistencia`)
    REFERENCES `BibliotecaDigital`.`cat_freciencia_asustencia` (`id_freciencia_asistencia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_seg_registroVisitante_cat_numero_acompanantes1`
    FOREIGN KEY (`id_num_acompanantes`)
    REFERENCES `BibliotecaDigital`.`cat_numero_acompanantes` (`id_numero_acompapantes`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
DEFAULT CHARACTER SET = latin1;

CREATE INDEX `fk_seg_registroVisitante_cat_rango_edades1_idx` ON `BibliotecaDigital`.`seg_registroVisitante` (`id_rango_edad` ASC);

CREATE INDEX `fk_seg_registroVisitante_cat_ocupaciones1_idx` ON `BibliotecaDigital`.`seg_registroVisitante` (`id_ocupacion` ASC);

CREATE INDEX `fk_seg_registroVisitante_cat_estado_civil1_idx` ON `BibliotecaDigital`.`seg_registroVisitante` (`id_estado_civil` ASC);

CREATE INDEX `fk_seg_registroVisitante_cat_razonVisita1_idx` ON `BibliotecaDigital`.`seg_registroVisitante` (`id_razonVisita` ASC);

CREATE INDEX `fk_seg_registroVisitante_cat_freciencia_asustencia1_idx` ON `BibliotecaDigital`.`seg_registroVisitante` (`id_frecuencia_asistencia` ASC);

CREATE INDEX `fk_seg_registroVisitante_cat_numero_acompanantes1_idx` ON `BibliotecaDigital`.`seg_registroVisitante` (`id_num_acompanantes` ASC);
...
CREATE TABLE IF NOT EXISTS `BibliotecaDigital`.`piezas` (
  ...
  CONSTRAINT `fk_piezas_pieza_multimedia1`
    FOREIGN KEY (`idPiezas`)
    REFERENCES `BibliotecaDigital`.`pieza_multimedia` (`id_pieza_multimedia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB
...
CREATE TABLE IF NOT EXISTS `BibliotecaDigital`.`multimedia` (
  ...
  CONSTRAINT `fk_multimedia_tipo_multimedia1`
    FOREIGN KEY (`id_tipo_multimedia`)
    REFERENCES `BibliotecaDigital`.`cat_tipo_multimedia` (`id_tipo_multimedia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_multimedia_pieza_multimedia1`
    FOREIGN KEY (`id_multimedia`)
    REFERENCES `BibliotecaDigital`.`pieza_multimedia` (`id_multimedia`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;

CREATE INDEX `fk_multimedia_tipo_multimedia1_idx` ON `BibliotecaDigital`.`multimedia` (`id_tipo_multimedia` ASC);
...
CREATE TABLE IF NOT EXISTS `BibliotecaDigital`.`autor` (
  ...
  CONSTRAINT `fk_autor_piezas1`
    FOREIGN KEY (`id_autor`)
    REFERENCES `BibliotecaDigital`.`piezas` (`id_autor`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `BibliotecaDigital`.`cat_epoca` (
  ...
  CONSTRAINT `fk_epoca_autor1`
    FOREIGN KEY (`id_epoca`)
    REFERENCES `BibliotecaDigital`.`autor` (`id_epoca`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
