...
CREATE TABLE `seg_registroVisitante` (
  `idseg_registroVisitante` int(11) NOT NULL AUTO_INCREMENT,
  `genero` char(1) DEFAULT NULL,
  `edad` int(11) DEFAULT NULL,
  `id_ocupacion` int(11) DEFAULT NULL,
  `estado_civil` varchar(45) DEFAULT NULL,
  `id_razonVisita` varchar(45) DEFAULT NULL,
  `frecuencia` int(11) DEFAULT NULL,
  `num_acompanantes` int(11) DEFAULT NULL,
  PRIMARY KEY (`idseg_registroVisitante`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2014-03-06 10:08:40
