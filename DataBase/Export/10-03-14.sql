CREATE DATABASE  IF NOT EXISTS `bibliotecadigital` /*!40100 DEFAULT CHARACTER SET latin1 */;
USE `BibliotecaDigital`;
-- MySQL dump 10.13  Distrib 5.6.13, for osx10.6 (i386)
--
-- Host: 127.0.0.1    Database: BibliotecaDigital
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=latin1 COMMENT='Tabla que contiene el catalogo de tipos de Usuario';
/*!40101 SET character_set_client = @saved_cs_client */;
...
INSERT INTO `c_tipo_usuario` VALUES (1,'Administrador','Administrador principal del sistema.'),(2,'Revisor','Revisor del sistema');
...
LOCK TABLES `cat_ocupaciones` WRITE;
/*!40000 ALTER TABLE `cat_ocupaciones` DISABLE KEYS */;
INSERT INTO `cat_ocupaciones` VALUES (1,'Estudiante'),(2,'Profesor'),(3,'Turista'),(4,'Visitante casual');
/*!40000 ALTER TABLE `cat_ocupaciones` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `cat_razonVisita`
--

DROP TABLE IF EXISTS `cat_razonVisita`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `cat_razonVisita` (
...
--
-- Dumping data for table `cat_razonVisita`
--

LOCK TABLES `cat_razonVisita` WRITE;
/*!40000 ALTER TABLE `cat_razonVisita` DISABLE KEYS */;
/*!40000 ALTER TABLE `cat_razonVisita` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `seg_registroVisitante`
--

DROP TABLE IF EXISTS `seg_registroVisitante`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `seg_registroVisitante` (
  `id_registroVisitante` int(11) NOT NULL AUTO_INCREMENT,
  `genero` char(1) DEFAULT NULL,
  `edad` int(11) DEFAULT NULL,
  `id_ocupacion` int(11) DEFAULT NULL,
  `estado_civil` varchar(45) DEFAULT NULL,
  `id_razonVisita` int(11) DEFAULT NULL,
  `frecuencia` int(11) DEFAULT NULL,
  `num_acompanantes` int(11) DEFAULT NULL,
  PRIMARY KEY (`id_registroVisitante`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `seg_registroVisitante`
--

LOCK TABLES `seg_registroVisitante` WRITE;
/*!40000 ALTER TABLE `seg_registroVisitante` DISABLE KEYS */;
/*!40000 ALTER TABLE `seg_registroVisitante` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Dumping events for database 'BibliotecaDigital'
--

--
-- Dumping routines for database 'BibliotecaDigital'
--
...
-- Dump completed on 2014-03-10 10:22:42
